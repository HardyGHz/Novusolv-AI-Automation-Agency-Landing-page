      ...
      <div className="flex flex-col gap-8">
            ...
            {section.steps.map((step, i) => (
              ...
              >
                <p className="text-[14px] leading-[150%] text-heading min-w-[2.5rem]">
                  {step.isSpecial ? (
                    <Sparkles size={20} className="text-[#E8630A]" />
                  ) : (
                    step.number
                  )}
                </p>
        ...
        <div className="flex">
          <a href="#contact" className="w-max">
            <button className="font-medium flex w-full items-center justify-center cursor-pointer bg-gradient-to-r from-[#E8630A] to-[#FF8C2A] text-[#000814] hover:from-[#D05A09] hover:to-[#E87020] py-2 px-4 h-[40px] rounded-xl transition-all shadow-md shadow-[#E8630A]/20 group">
          ...
          <div className="flex flex-col flex-1 gap-6 lg:gap-12">
            ...
            >
              ...
              <div className="relative flex flex-col gap-4 lg:gap-6 z-[1]">
                <div>
                  <p className="text-[#E8630A] font-semibold text-[14px] uppercase tracking-wider mb-3">{t('how_it_works.our_services')}</p>
                  ...
                  {sections.map((section) => (
                    ...
                    >
                      <div className={clsx(
                        ...
                        activeSection === section.id ? 'bg-[#E8630A] scale-125' : 'bg-heading'
                      )} />
                      <p className={clsx(
                        'text-[16px] leading-[150%] font-semibold grow transition-colors duration-300',
                        activeSection === section.id ? 'text-[#E8630A]' : 'text-heading'
                      )}>{section.navLabel}</p>
                    </div>
                  ))}
                </div>
                  ...
                  {sections.map((section) => (
                    ...
                    >
                      <div className={clsx(
                        ...
                        activeSection === section.id ? 'bg-[#E8630A]' : 'bg-heading'
                      )} />
                      <p className={clsx(
                        'text-[16px] leading-[150%] font-semibold',
                        activeSection === section.id ? 'text-[#E8630A]' : ''
                      )}>{section.navLabel}</p>
                    </div>
                  ))}
                </div>
