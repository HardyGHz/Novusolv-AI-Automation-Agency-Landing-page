...
export default function WebsiteBuilderCTA() {
  ...
  return (
    <section className="py-[120px] max-md:py-[80px] relative overflow-hidden flex items-center justify-center">
      <div className="absolute w-[60vw] h-[60vh] rounded-full blur-[140px] bg-indigo-500/10 mix-blend-multiply dark:mix-blend-lighten pointer-events-none z-0"></div>
          ...
          <div className="flex flex-col md:flex-row gap-10 items-center justify-between relative z-10">
            <div className="flex flex-col gap-4 md:w-2/3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold uppercase tracking-wider text-indigo-500">Website Builder</span>
              </div>
